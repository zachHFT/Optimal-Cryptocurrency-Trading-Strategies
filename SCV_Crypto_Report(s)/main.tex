...
\begin{itemize}
\item{To extract the Data, you can do so as per the call of getuptodate_binance_data.update_data_for_basepair(base_pair='USDT', nb_symbols_limit=5, bin_size='1d') in get_ohlc_historical_data.ipynb}

\item{The data will be saved in a folder named \'Binance_OHLC\' located within a 'Data' folder within your project folder. If you do not have such folders, create some. (If you are familiar with chdir python function to change and work with your choice directory you can ignore this remark).}
