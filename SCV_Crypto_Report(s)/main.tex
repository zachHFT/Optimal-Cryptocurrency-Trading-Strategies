...
\newcommand{\reporttitle}{Boundary value problem in a rectangle: Electric circuits and the Schwarz-Christoffel transformation.}
\newcommand{\reportauthor}{Kai Cooper}
\newcommand{\reportsecondauthor}{Julian Yu}
\newcommand{\reportthirdauthor}{Karlo Bujas}
\newcommand{\reportfourthauthor}{Ziming Wang}
\newcommand{\reportfifthauthor}{Zelun Bi}
\newcommand{\supervisor}{Professor Darren Crowdy}
