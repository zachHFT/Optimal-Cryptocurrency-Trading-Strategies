...
\begin{itemize}
    \item 
To extract the Data, you can do so as per the call of \path[get_uptodate_binance_data.update_data_for_basepair(base_pair='USDT', nb_symbols_limit=5, bin_size='1d')] in \path[get_ohlc_historical_data.ipynb]
    \item
